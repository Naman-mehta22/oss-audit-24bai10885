...
Student Name: Naman Mehta
Roll Number: 24BAI10885
...
script2_package_inspector.sh	Check LibreOffice installation	dpkg queries, case statements
...
Dependencies
•	bash (built-in)
•	dpkg/apt (Ubuntu package manager)
